    ...
    <aside class="admin-sidebar-drawer" id="adminSidebar">
        ...
        <nav class="sidebar-menu-ul">
            ...
            <a href="{{ route('admin.notifications') }}">
                <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></svg> Orders
            </a>
            <a href="#">
        ...
        <section class="table-container-white">
            <table class="crud-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><img src="{{ asset('images/products/'.$p->image) }}" class="table-thumb-img" alt=""></td>
                        <td>
                    ...
                    @empty
                    <tr><td colspan="6" style="text-align: center; color: #888; padding: 40px 0;">Tidak ada produk reptil di database MongoDB Compass.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </section>
